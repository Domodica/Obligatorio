...
public class TransferirAMozoJDialog extends javax.swing.JDialog {
    ...
    private SistemaAtencionCliente sa;
    ...
    private void iniciarTransferencia() {
        ...
        controlador.getMozo().solicitarTransferencia(mozoDestino, controlador.getMesaSeleccionada());        
    }

    private void mostrarListaMozosLogueados() {
        this.lstMozosLogueados.removeAll();
        ArrayList<Mozo> mozos = controlador.getFachada().getMozos(); ///////////// Poner luego los logueados solamente y excluir a el mismo
